...
#ifndef OPEN_SPIEL_GAMES_SETBACK_POKER_H_
#define OPEN_SPIEL_GAMES_SETBACK_POKER_H_
...
class SetbackGame;
class SetbackObserver;

class SetbackState : public State {
 public:
  explicit SetbackState(std::shared_ptr<const Game> game);
  SetbackState(const SetbackState&) = default;
...
class SetbackGame : public Game {
 public:
  explicit SetbackGame(const GameParameters& params);
  ...
  std::shared_ptr<const Game> Clone() const override {
    return std::shared_ptr<const Game>(new SetbackGame(*this));
  }
  ...
  std::shared_ptr<SetbackObserver> default_observer_;
  std::shared_ptr<SetbackObserver> info_state_observer_;
  std::shared_ptr<SetbackObserver> public_observer_;
  std::shared_ptr<SetbackObserver> private_observer_;
...
}  // namespace setback_poker
}  // namespace open_spiel

#endif  // OPEN_SPIEL_GAMES_SETBACK_POKER_H_
